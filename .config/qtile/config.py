...
keys = [
    ...
    # Spawn app
        # Rofi
    Key(["mod4"], "r", lazy.spawn("/home/lowkey/.config/rofi/launchers/type-6/launcher.sh")),
    Key(["mod4"], "x", lazy.spawn("/home/lowkey/.config/rofi/powermenu/type-5/powermenu.sh")),
]
...
layouts = [
    layout.Columns(border_focus_stack=["#d75f5f", "#8f3d3d"], border_width=4, border_focus="#bd6f3e", margin=4),
    layout.Max(),
...
screens = [
    Screen(
        wallpaper="~/Pictures/Wallpapers/Kojiro.png",
        wallpaper_mode="fill",
        bottom=bar.Bar(
            [
